...
**Task Wrap-up (2026-05):** Core objective achieved — the FastEndpointSourceGenerator can now be safely and explicitly enabled/disabled per project via `<EnableApiEndpointGeneration>`. Task moved to Done.
