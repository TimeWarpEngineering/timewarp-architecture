...
// client GetResponse. Page owns only chrome UX (expanded row). Loading = Credentials null;
// IsBusy = ActionTrackingState (TrackAction on fetch/add/revoke). API failures toast via
