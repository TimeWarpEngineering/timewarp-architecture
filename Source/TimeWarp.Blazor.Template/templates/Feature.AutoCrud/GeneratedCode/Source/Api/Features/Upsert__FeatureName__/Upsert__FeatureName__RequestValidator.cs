namespace __RootNamespace__.Features.__FeatureName__s
{
  ...
  public class Upsert__FeatureName__RequestValidator : AbstractValidator<Upsert__FeatureName__Request>
  {

    public Upsert__FeatureName__RequestValidator()
    {
      ...
      RuleFor(aUpsert__FeatureName__Request => aUpsert__FeatureName__Request.Price)
        .NotEmpty().GreaterThan(0);
      RuleFor(aUpsert__FeatureName__Request => aUpsert__FeatureName__Request.Name)
