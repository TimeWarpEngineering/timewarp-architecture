...
namespace LiveSharp
{
  class LiveSharpDashboard : ILiveSharpDashboard
  {
    ...
    public void Configure(ILiveSharpRuntime aLiveSharpRuntime)
    {
      aLiveSharpRuntime.Config.SetValue("disableBlazorCSS", "false");
      aLiveSharpRuntime.UseDefaultBlazorHandler();
    }

    public void Run(ILiveSharpRuntime aLiveSharpRuntime)
    {
