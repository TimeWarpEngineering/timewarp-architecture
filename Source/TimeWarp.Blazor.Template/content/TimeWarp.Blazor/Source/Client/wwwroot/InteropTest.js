const dispatchIncrementCountAction = () => {
  ...
  const IncrementCountActionName = "TimeWarp.Blazor.Client.CounterFeature.CounterState+IncrementCounterAction, TimeWarp.Blazor.Client, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null";
