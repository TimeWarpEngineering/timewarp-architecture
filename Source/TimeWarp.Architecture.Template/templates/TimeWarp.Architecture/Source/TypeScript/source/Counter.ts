export class Counter {
  ...
  DispatchIncrementCountAction() {
    ...
    const IncrementCountActionName =
      "TimeWarp.Architecture.Features.Counters.CounterState+IncrementCounterAction, TimeWarp.Architecture.Client, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null";
