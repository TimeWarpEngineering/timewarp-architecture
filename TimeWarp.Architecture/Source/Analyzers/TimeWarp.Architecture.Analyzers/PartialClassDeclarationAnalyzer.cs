...
public class PartialClassDeclarationAnalyzer : DiagnosticAnalyzer
{
  ...
  private static readonly LocalizableString Description = "Partial classes should have one primary declaration in the main file with full specifiers and others with minimal declaration.";
  ...
  public const string AnalyzerReleaseTrackingId = "TWPA0001";    public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics { get { return ImmutableArray.Create(Rule); } }
